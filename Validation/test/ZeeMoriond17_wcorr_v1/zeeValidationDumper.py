...
(abs(leadingPhoton.superCluster.eta) < 2.5 && abs(subLeadingPhoton.superCluster.eta) < 2.5 && leadingPhoton.hasPixelSeed()==1) &&
                                        (leadingPhoton.pt > 30) &&
                                        (leadingPhoton.hadronicOverEm < 0.07) &&
                                        ...
                                        (leadingPhoton.full5x5_sigmaIetaIeta < 0.011 && leadingPhoton.pfPhoIso03 < 4.0 && leadingPhoton.trkSumPtHollowConeDR03 < 6.0 ))) ||
                                        (leadingPhoton.isEE && leadingPhoton.hadronicOverEm < 0.035 &&
                                        (leadingPhoton.full5x5_r9 > 0.9 ||
                                        (leadingPhoton.full5x5_sigmaIetaIeta < 0.029 && leadingPhoton.pfPhoIso03 < 4.0 && leadingPhoton.trkSumPtHollowConeDR03 < 6.0 )))) &&
                         ...
                         (abs(leadingPhoton.superCluster.eta) < 2.5 && abs(subLeadingPhoton.superCluster.eta) < 2.5 && subLeadingPhoton.hasPixelSeed()==1) &&
                                          ...
                                          (subLeadingPhoton.hadronicOverEm < 0.07) &&
                                          ((leadingPhoton.full5x5_r9 > 0.5 && leadingPhoton.isEB) || (leadingPhoton.full5x5_r9 > 0.8 && leadingPhoton.isEE)) &&
                                          ((subLeadingPhoton.full5x5_r9 > 0.5 && subLeadingPhoton.isEB) || (subLeadingPhoton.full5x5_r9 > 0.8 && subLeadingPhoton.isEE)) &&
                                          (( subLeadingPhoton.isEB &&
                                          (subLeadingPhoton.full5x5_r9 > 0.85 ||
                                          (subLeadingPhoton.full5x5_sigmaIetaIeta < 0.011 && subLeadingPhoton.pfPhoIso03 < 4.0 && subLeadingPhoton.trkSumPtHollowConeDR03 < 6.0 ))) ||
                                          (subLeadingPhoton.isEE && subLeadingPhoton.hadronicOverEm < 0.035 &&
                                          (subLeadingPhoton.full5x5_r9 > 0.9 ||
                                          (subLeadingPhoton.full5x5_sigmaIetaIeta < 0.029 && subLeadingPhoton.pfPhoIso03 < 6.0 && subLeadingPhoton.trkSumPtHollowConeDR03 < 6.0 )))) &&
...
""", 0)
                       ...
                       variables=["leadPhIso        := leadingPhoton.pfPhoIso03()",
                                  ...
                                  "leadr9_5x5_by_3x3:= leadingPhoton.full5x5_r9/leadingPhoton.r9",
                                  ...
                                  "subleadr9_5x5_by_3x3:= subLeadingPhoton.full5x5_r9/subLeadingPhoton.r9",
...
process.p = cms.Path(process.flashggUpdatedIdMVADiPhotons*process.flashggDiPhotonSystematics*process.dataRequirements*process.flashggDiPhotonMVA*process.DiPhotonWithZeeMVADumper*process.diphotonDumper)
